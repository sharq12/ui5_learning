		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Odata crud",
									"targetURL": "#project4odatacrud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project4odatacrud-display": {
								"semanticObject": "project4odatacrud",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project4odatacrud",
									"url": sap.ui.require.toUrl("project4odatacrud")
								}
							}
						}
					}
